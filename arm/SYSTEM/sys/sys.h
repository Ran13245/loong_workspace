...
extern float Position_A,Position_B,Position_C; //PID������ر���  
extern float Target_A,Target_B,Target_C,Rate_A,Rate_B,Rate_C;     //���Ŀ��ֵ
extern int16_t Target_X,Target_Y,Target_Z;
extern int Max_Velocity,RC_Velocity;
extern u8 rxbuf[6],Urxbuf[6],CAN_ON_Flag,Usart_ON_Flag,Usart_Flag,Usart_ON_Flag2;  //CAN�ʹ��ڿ�����ر���
extern u8 txbuf[8],txbuf2[8],Menu;             //CAN������ر���
